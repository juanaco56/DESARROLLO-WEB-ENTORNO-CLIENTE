...
setTimeout(function() {
    let popup = window.open("", "Bienvenida", "width=300,height=150,scrollbars=no,menubar=no,toolbar=no,location=no");
    popup.document.write("<p>Bienvenido a la web de la Asociación Deportiva Juanac056</p>");
